...
URL_OVERRIDES = {
    ...
    "qissah-emperor-valley": "https://www.fragrantica.com/perfume/Gissah/Imperial-Valley-80051.html",
}
...
MANUAL = {
    ...
    "marj": E("Marj", "Ahmed Al Maghribi", ["rose", "oud", "woody", "amber"], conf="low",
        family="Oud / Animalic", gender="unisex", review=True),
    "mani": E("Ma'ani", "Ahmed Al Maghribi", ["floral", "woody", "rose", "musky"],
        top=["Rose", "Jasmine"], heart=["Lily of the Valley", "Violet"],
        base=["Sandalwood", "Cedarwood", "Vetiver"], conf="medium",
        family="Floral", gender="unisex", review=False),
    ...
    "crown": E("Crown", "Arabian House", ["oud", "amber", "woody", "warm spicy"], conf="low",
        family="Oud / Animalic", gender="unisex", review=True),
    "qissah-emperor-valley": E("Imperial Valley", "Gissah",
        ["oud", "rose", "amber", "musk", "leather"],
        top=["Davana", "Bergamot", "Pink Pepper"],
        heart=["White Amber", "Rosemary", "Oud"],
        base=["Musk", "Leather", "Vetiver"], conf="medium",
        family="Oud / Animalic", gender="unisex", review=False),
